"""Resilience-orchestration collaborator for :class:`~dbkit._async.database.AsyncDatabase`
(§11.1, §14, §16, §17).
...
class ResilientExecutor:
    ...
    async def entry(self, target: DatabaseTarget) -> tuple[EngineEntry, ResolvedRoute]:
    ...
    async def execute_with_resilience(
        ...
        *,
        ...
        """
        entry, _route = await self.entry(target)
        ...
        async def attempt() -> Any:
            ...
            async with contextlib.AsyncExitStack() as stack:
                ...
                await stack.enter_async_context(limiter.acquire(tier, timeout=limiter_timeout))
                ...
                scope = await stack.enter_async_context(
                    self.scope(
                        target,
                        query,
    ...
    async def scope(
        ...
        *,
        ...
        with self._tracer.span(
            ...
            conn = await self.acquire(entry.engine, labels, query_name)
            ...
            try:
                ...
                if commit:
                    try:
                        ...
                        # Mirror _AsyncTransactionManager._commit(): a failure during COMMIT
